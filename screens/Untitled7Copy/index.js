...
const Untitled7Copy = () => {
  ...
  return <SafeAreaView style={styles.safeArea}>
      ...
      backgroundColor: '#f0f0f1'
          ...
          <Pressable><View style={styles.column1}><Text style={styles.uxayRAdg}>Testing World </Text><Pressable onPress={() => {
            navigation.navigate("account", {
              testy: "testy"
            });
          }}><ImageBackground style={styles.JUmVpico} source={{
            ...
            }} resizeMode="cover"></ImageBackground></Pressable></View></Pressable>
